...
export function Footer() {
  return (
    <footer className="bg-[#a100ff]/20 border-t border-white/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">AEON</span>
                ...
                Create stunning videos with AI-powered generation, editing, and effects. 
                Transform your ideas into professional content in minutes.
              </p>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            © 2024 AEON Video. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <span className="text-white/60 text-sm">Made with ❤️ for creators</span>
          </div>
        </div>
      </div>
    </footer>
