...
export const env = createEnv({
  ...
  experimental__runtimeEnv: {
    NEXT_PUBLIC_STRIPE_PUBLISHABLE_API:
      process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_API,
