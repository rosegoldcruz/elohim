...
import { AnimatedTooltip } from "@aeon/ui/animated-tooltip";
import { BackgroundLines } from "@aeon/ui/background-lines";
import { Button } from "@aeon/ui/button";
import { ColourfulText } from "@aeon/ui/colorful-text";
...
const people = [
  {
    id: 1,
    name: "AEON Core",
    designation: "AI Video Generation Lead",
    image: "https://avatars.githubusercontent.com/u/10096899",
    link: "https://x.com/aeonai",
  },
  {
    id: 2,
    name: "Agent Architect",
    designation: "Modular Systems Designer",
  ...
  },
  {
    id: 4,
    name: "Script Engine",
    designation: "NLP & Content Generation",
              ...
              <div className="flex flex-col pt-4 md:pt-36 lg:pt-36 xl:pt-36">
                <div className="mt-20">
                  <div
                    ...
                    {dict.marketing.title || "Create stunning AI videos with "}
                    <ColourfulText text="AEON"/>
                  </div>
                </div>

                <div className="mt-4">
                  <span className="text-neutral-500 dark:text-neutral-400 sm:text-lg">
                    {dict.marketing.sub_title || "Advanced Efficient Optimized Network - AI-powered video generation platform with modular agent architecture."}
                  </span>
                </div>
